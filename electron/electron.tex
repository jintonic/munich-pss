...
n-type germanium detectors, I}
%
\author{I.~Abt \and A.~Caldwell \and D.~Lenz \and J.~Liu \and
B.~Majorovits}
%
%\offprints{}          % Insert a name or remove this line
%
\institute{Max-Planck-Institut f\"ur Physik, M\"unchen, Germany}
\mail{jingliu@mppmu.mpg.de}
%
\date{\today}
%\date{Received: date / Revised version: date}
% The correct dates will be entered by Springer
%
\abstract{In order to achieve an extremely low background level, ture
coaxial segmented $n$-type germanium detectors are considered to be
used in the second phase of the GERmanium Detector Array (GERDA)
experiment searching for the neutrinoless double beta decay of
$^{76}$Ge. Pulse shape analysis is needed to distinguish beta decay
signals from background events depositing energies within one segment
of a detector. Its efficiency can only be correctly estimated by
reliable pulse shape simulation. A fully functional pulse shape
simulation package is jointly developed by the GERDA and Majorana
collabrations. The simulation was compared to the data collected with
two GERDA prototype detectors. It was proven to be reliable in
general. Several discrepancies were founded and can be explained by
the inhomogeneous impurity distribution in the detector.
...
shapes as shown in Fig~\ref{f:valley}.
\begin{figure}\centering
...
111 \rangle$ valley. Local coordinates, $x^{\prime} y^{\prime}
z^{\prime}$, are defined as shown in Fig.~\ref{f:axes}. The effective
mass tensor, $\gamma_{0}$, in $x^{\prime} y^{\prime} z^{\prime}$
coordinates has a very simple expression:
\begin{equation} 
\label{e:g0} 
\gamma_{0} \equiv \left( 
\begin{array}{ccc} 
...
\begin{figure}\centering
\includegraphics[width=0.8\linewidth]{axes}   
